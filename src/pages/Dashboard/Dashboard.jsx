...
import api from '../../utils/axios'; // Đảm bảo đường dẫn tới file axios config của bạn
...
export default function Dashboard() {
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            // Mapping dữ liệu từ API (dựa trên ảnh Postman bạn cung cấp)
            ...
            <div className="card" style={{ marginTop: '2rem' }}>
                ...
                <div className="card-content">
                    <div className="activity-list">
                        ...
                        ) : activities?.length > 0 ? ( // Thêm dấu ? ở đây
                            activities.map((activity) => (
                                <div className="activity-item" key={activity.id || Math.random()}>
                                    <div className="activity-dot" style={{ background: activity.xpEarned > 0 ? '#22c55e' : '#3b82f6' }}></div>
                                    <div className="activity-content">
                                        <p className="activity-action">
                                            {activity.action}
                                            {activity.xpEarned > 0 && <strong style={{ color: '#22c55e' }}> (+{activity.xpEarned} XP)</strong>}
                                        </p>
